            ...
            <div class="col s12 m12 l12">
                <div class="card">
                    <div class="card-content">
                        <span class="card-title">Manage Category</span>
                        <a class="waves-effect waves-light btn" href="{{ url(route('backend.category.create')) }}"><i class="material-icons left">open_in_new</i>Add New Data</a><br>
                        <table id="example" class="display responsive-table datatable-example">
                            ...
                            @foreach($model as $row)
                                <tr>
                                    ...
                                    <td>
                                        <!-- <a href="{{ route('backend.category.show', ['id' => $row->id]) }}" class="btn-floating blue" style="opacity: 1;"><i class="material-icons">subject</i></a> -->
                                        <a href="{{ route('backend.category.edit', ['id' => $row->id]) }}" class="btn-floating orange" style="opacity: 1;"><i class="material-icons">mode_edit</i></a>
                                    </td>
                                </tr>
                            <?php $no++; ?>
                            @endforeach
